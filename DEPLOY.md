...
- **ต่อ SMM provider จริง**: ตอนนี้ออเดอร์เลื่อนสถานะเอง/แอดมินกดเอง ยังไม่ยิงไป supplier จริง
- **เช็คสลิป TrueMoney อัตโนมัติ** (SlipOK/EasySlip) — ตอนนี้แอดมินอนุมัติเอง
- **อีเมล**: ตั้ง `SMTP_*` เพื่อให้ "ลืมรหัสผ่าน" ส่งเมลจริง (ไม่ตั้ง = พิมพ์ลิงก์ออก log)
